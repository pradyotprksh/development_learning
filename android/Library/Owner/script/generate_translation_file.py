...
try:
    ...
    translation_class_str = """package com.pradyotprakash.libraryowner.app.localization
...
"""
    ...
    translation_kotlin_file = "./app/src/main/java/com/pradyotprakash/libraryowner/app/localization/TR.kt"
