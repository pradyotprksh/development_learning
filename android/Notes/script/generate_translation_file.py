...
try:
    ...
    translation_class_str = """package com.pradyotprakash.notes.app.localization
...
"""
    ...
    translation_kotlin_file = "./app/src/main/java/com/pradyotprakash/notes/app/localization/TR.kt"
