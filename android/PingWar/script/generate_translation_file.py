...
try:
    ...
    translation_class_str = """package com.pradyotprakash.pingwar.app.localization
...
"""
    ...
    translation_kotlin_file = "./app/src/main/java/com/pradyotprakash/pingwar/app/localization/TR.kt"
