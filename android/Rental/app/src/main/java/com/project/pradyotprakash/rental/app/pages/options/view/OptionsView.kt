...
import com.project.pradyotprakash.rental.core.helper.WebViewHelper
import com.project.pradyotprakash.rental.core.utils.Constants.informationURL
...
fun OptionsView(
    ...
    Box(
        ...
        IconButton(
            onClick = {
                WebViewHelper.launchWebView(context, informationURL)
            },
