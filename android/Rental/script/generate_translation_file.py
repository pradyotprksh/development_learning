...
try:
    ...
    translation_class_str = """package com.project.pradyotprakash.rental.app.localization
...
"""
    ...
    translation_kotlin_file = "./app/src/main/java/com/project/pradyotprakash/rental/app/localization/TR.kt"
