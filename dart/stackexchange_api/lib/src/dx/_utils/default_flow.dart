...
Future<void> onlyExecuteFlow<P extends Parameters, R extends Result>({
  required Core core,
  required P params,
}) async {
  var fiber = Fiber(
    action: () => _onlyExecuteFlow<P, R>(
      params: params,
      core: core,
    ),
  );
...
Future<void> _onlyExecuteFlow<P extends Parameters, R extends Result>({
  required Core core,
  required P params,
}) async {
