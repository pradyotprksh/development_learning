...
interface ContestEffectController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: ContestResource.Effect)

    suspend fun getDetails(context: ApplicationCall, resource: ContestResource.Effect.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: ContestResource.Effect.Pagination
    )
}