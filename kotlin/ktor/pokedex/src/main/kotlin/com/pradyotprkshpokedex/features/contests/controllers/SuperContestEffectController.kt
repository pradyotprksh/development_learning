...
interface SuperContestEffectController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: ContestResource.SupperContestEffect)

    suspend fun getDetails(context: ApplicationCall, resource: ContestResource.SupperContestEffect.Id)
