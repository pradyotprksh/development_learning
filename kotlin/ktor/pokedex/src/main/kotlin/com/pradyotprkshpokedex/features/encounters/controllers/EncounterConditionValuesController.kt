...
interface EncounterConditionValuesController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: EncountersResource.ConditionValue)

    suspend fun getDetails(context: ApplicationCall, resource: EncountersResource.ConditionValue.Id)
