...
interface ItemCategoriesController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: ItemsResource.Category)

    suspend fun getDetails(context: ApplicationCall, resource: ItemsResource.Category.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: ItemsResource.Category.Pagination
    )
}