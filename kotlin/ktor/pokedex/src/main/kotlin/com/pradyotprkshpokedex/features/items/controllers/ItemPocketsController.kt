...
interface ItemPocketsController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: ItemsResource.Pockets)

    suspend fun getDetails(context: ApplicationCall, resource: ItemsResource.Pockets.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: ItemsResource.Pockets.Pagination
    )
}