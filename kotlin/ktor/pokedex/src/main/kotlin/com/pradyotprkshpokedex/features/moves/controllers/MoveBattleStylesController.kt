...
interface MoveBattleStylesController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: MovesResource.BattleStyle)

    suspend fun getDetails(context: ApplicationCall, resource: MovesResource.BattleStyle.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: MovesResource.BattleStyle.Pagination
    )
}