...
interface MoveCategoriesController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: MovesResource.Category)

    suspend fun getDetails(context: ApplicationCall, resource: MovesResource.Category.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: MovesResource.Category.Pagination
    )
}