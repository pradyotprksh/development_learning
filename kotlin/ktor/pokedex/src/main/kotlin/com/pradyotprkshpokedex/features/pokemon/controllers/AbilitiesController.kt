...
interface AbilitiesController {
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: PokemonResource.Ability)

    suspend fun getDetails(context: ApplicationCall, resource: PokemonResource.Ability.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: PokemonResource.Ability.Pagination
    )
}