...
interface PokemonSpeciesController {
    /**
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: PokemonResource.Species)

    suspend fun getDetails(context: ApplicationCall, resource: PokemonResource.Species.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: PokemonResource.Species.Pagination
    )
}