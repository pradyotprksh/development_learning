...
interface StatsController {
     ...
     */
    suspend fun getAll(context: ApplicationCall, resource: PokemonResource.Stat)

    suspend fun getDetails(context: ApplicationCall, resource: PokemonResource.Stat.Id)

    suspend fun getByPagination(
        context: ApplicationCall,
        resource: PokemonResource.Stat.Pagination
    )
}